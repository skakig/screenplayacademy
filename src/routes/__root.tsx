...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SceneSmith Studio is the AI-powered writer's room for screenplays, novels, worldbuilding, comedy, and audio storytelling — from first spark to final pitch." },
      { name: "author", content: "SceneSmith Studio" },
      { property: "og:site_name", content: "SceneSmith Studio" },
      { property: "og:title", content: "SceneSmith Studio" },
      { property: "og:description", content: "An AI-powered writer's room for screenplays, novels, worldbuilding, comedy, and audio storytelling." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SceneSmith Studio" },
      { name: "twitter:description", content: "An AI-powered writer's room for screenplays, novels, worldbuilding, comedy, and audio storytelling." },
