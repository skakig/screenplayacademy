...
export const i18nStrings = {
  ...
  "collab.presence.peerCaretHere": "{{name}} — caret on this line",
  "collab.presence.peerTypingHere": "{{name}} is typing on this line",
  "collab.presence.peerCaretAria": "Show details for {{name}} editing this line",
  ...
  "editor.focus.toolbarLabel": "Focus mode toolbar",
  "editor.focus.now": "Now",
  "editor.focus.change": "Change",
  "editor.focus.changeType": "Change block type",
  "editor.focus.changeTitle": "Change element type (Tab)",
  "editor.focus.newLine": "New line",
  "editor.focus.newLineTitle": "Insert new line (Enter)",
  "editor.focus.aiContinue": "AI continue",
  "editor.focus.aiContinueTitle": "Ask AI to continue from here",
  "editor.focus.thinking": "Thinking…",
  "editor.focus.exit": "Exit Focus",
  "editor.focus.exitTitle": "Exit Focus Mode (Esc)",
  "characters.builder.portrait.gateNeed": "Complete more steps for a truthful portrait ({filled}/{needed})",
  "characters.builder.portrait.gateReady": "Profile ready — portrait will reflect the full character",
  "characters.builder.portrait.recommendedBadge": "Recommended",
  "characters.builder.portrait.promptTitle": "Portrait prompt (auto-composed)",
  "characters.builder.portrait.promptHint": "Rebuilt from every step you've filled so your cast looks like one film.",
